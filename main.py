...
def retrieval_qa_pipline(device_type, use_history, promptTemplate_type="llama"):
    ...
    """
    EMBEDDING_MODEL_NAME=env["model"]
    PERSIST_DIRECTORY=env["vectorDirectory"]
    CHROMA_SETTINGS=env["CHROMA_SETTINGS"]
    embeddings = OllamaEmbeddings(model=EMBEDDING_MODEL_NAME, model_kwargs={"device": device_type})
...
if __name__ == "__main__":
    ...
    vectorMain(env)
    main("cuda",True,True,"orca-mini",True)
